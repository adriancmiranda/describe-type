...
test('describe-type/is expusure', t => {
	...
	// t.is(toString.call(describeType.is.args.empty), '[object Function]');
	...
	t.is(toString.call(describeType.is.defined), '[object Function]');
	...
	t.is(toString.call(describeType.is.type), '[object Function]');
